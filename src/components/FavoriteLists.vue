...
export default defineComponent({
    ...
    methods: {
        ...
        async addList(favoriteList) {
            const newList = await createFavoriteList(favoriteList.name, favoriteList.owner.email)
...
<template>
    <div class="box">
        ...
        <div class="tags has-addons">
            <a @click="createNewList" class="tag title is-6 has-background-grey-lighter">Create a new list</a>
